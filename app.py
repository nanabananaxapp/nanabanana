...
def generate_images():
    ...
    try:
        ...
        base_prompt = "Amazing details skin-texture, top camera quality, refine details, enhanced quality!! 8k, very detailed,high-definition, high-fidelity, high-resolution, dslr quality. always keep photo resolution proportions. and make this photo as I / We are: "
