...
def generate_images():
    ...
    try:
        ...
        base_prompt = " .exact facial identity and bone structure preserved, but the pose and the scene, and the moment can be different when relevant. change outfit if relevant to the scene. Amazing details, pixel-perfect photo. Detailed, realistic skin-texture, rendered with micro-level detail. body parts are always very detailed, perfect, and realistic. top camera quality, refine details, enhanced quality!! 8k, crisp and consistent, very detailed,high-definition, high-fidelity, high-resolution, DSLR quality."
