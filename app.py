...
def generate_images():
    ...
    try:
        ...
        base_prompt = " .Do not change the face appearance, exact facial identity preserved, Amazing details, realistic skin-texture, rendered with micro-level detail. all body parts are always very detailed, perfect, and realistic. excellent realistic camera quality, refined details, enhanced quality!! 8k, crisp and consistent, very detailed,high-definition, high-fidelity, high-resolution, DSLR quality."
