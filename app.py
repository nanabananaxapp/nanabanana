...
def generate_images():
    ...
    try:
        ...
        base_prompt = " .same exact face from the original photo preserved realistically with full detail. refine details, enhanced quality, high-definition, high-fidelity, high-resolution, DSLR quality. "
